"""Scheduler-owned reflex output fencing for generated RTP."""
...
class OutputLease:
    """One scheduler-authorized generated output generation."""
...
class SchedulerReflexRejectionError(Exception):
    """Raised when a reflex event cannot open the next scheduler turn."""


@final
class SchedulerOutputFence:
    """Own generated RTP admission through the live session scheduler."""

    def __init__(self, scheduler: SessionScheduler) -> None:
        """Bind media output admission to one session scheduler."""
    ...
    def activate(
        ...
        *,
        ...
        """Open the current scheduler turn for its first generated output."""
    ...
    def interrupt(
        ...
        *,
        ...
        """Fence active output and require its exact Sound flush acknowledgement."""
    ...
    def acknowledge(self, acknowledgement: FlushAcknowledgement) -> bool:
        """Admit a replacement only for its exact pending Sound acknowledgement."""
    ...
    def can_emit(self, stream: StreamKey, epoch: CancellationEpoch) -> bool:
        """Return whether a packet matches the live scheduler output lease."""
