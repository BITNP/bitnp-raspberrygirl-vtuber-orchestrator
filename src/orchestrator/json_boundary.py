"""Typed JSON parser for small Orchestrator fixture files."""
...
class JsonBoundaryError(ValueError):
    """Raised when JSON text cannot be parsed into typed values."""
...
@final
class _JsonParser:
    """Mutable cursor parser for JSON values; mutation is the parser state."""
...
def parse_json_value(text: str) -> JsonValue:
    """Parse JSON text into the internal recursive JsonValue union."""
