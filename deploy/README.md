...
3. Speak a short question with a deliberately recognizable voice and wording into Mic for at least one second. The bridge batches fifty 20 ms Mic frames, sends fixed 16 kHz mono PCM WAV to ASR, obtains an LLM answer, requests TTS, converts accepted mono PCM16 TTS WAV into canonical 16 kHz audio when needed, then sends generated 16 kHz L16 RTP to Sound.
