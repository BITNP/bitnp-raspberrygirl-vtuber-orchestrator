...
Orchestrator 是 Raspberry Girl 的中心仓库，拥有规范协议、会话状态、调度、LLM/TTS 边界和跨模块契约验证。Mic 负责端点检测和 ASR，并通过认证 control connection 提交结构化 ASR 结果；Orchestrator 是唯一 Gate、Brain、状态写者与 effect 派发者。
