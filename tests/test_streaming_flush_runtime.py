...
def _source_registration() -> str:
    return _envelope(_EnvelopeFields(
...
def _envelope(fields: _EnvelopeFields) -> str:
    envelope: dict[str, JsonValue] = {
        "schema_version": "1.0.0", "event_type": fields.event_type,
        "event_id": fields.event_type, "source": fields.source,
        "time": "2026-07-28T00:00:00Z", "trace_id": fields.trace_id,
        "session_id": fields.session_id, "seq": fields.seq, "data": fields.data,
    }
...
def _codec() -> dict[str, JsonValue]:
    return {
        "format": "L16", "clock_rate_hz": 16_000, "channels": 1,
        "payload_type": 96, "samples_per_frame": 320,
    }
...
def _config() -> TransportConfig:
    return TransportConfig(
        "127.0.0.1", 8765, "127.0.0.1", 5004, "127.0.0.1", 8765,
        5004, "ws", None, None, None,
    )
