...
Mic  -- UDP L16 RTP --> Orchestrator -- UDP 生成的 L16 RTP --> Sound
                              |
                              +-> 50 帧 -> ASR -> turn pipeline -> LLM -> TTS
```
