...
Mic  -- L16 RTP over UDP --> Orchestrator -- generated L16 RTP over UDP --> Sound
                              |
                              +-> 50 frames -> ASR -> turn pipeline -> LLM -> TTS
```
